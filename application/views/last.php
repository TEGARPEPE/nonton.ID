...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark sticky-top"
		...
		<div class="container" style="justify-content:center;">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				...
				<!-- Navbar Links -->
				<ul class="navbar-nav">
					<li class="nav-item"><a href="about.html" class="nav-link px-3 pt-1 pb-1">About</a></li>
	...
	<section class="ftco-section" style="background-color:#222;padding:0px;padding-top:20px;">
