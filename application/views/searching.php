...
<body bg-dark>
	...
	<section class="ftco-section" style="background-color:#222;padding-bottom:0px;padding-top:15px;">
		<div class="container" style="min-widht:1000px;">
			<div class="row justify-content-space-between mb-1 pb-0">
				<div class="col heading-section ftco-animate " style="display: flex;align-items:center;">
					...
					<h5 class="text-light">Hasil Pencarian: <em><?= $keyword; ?></em></h5>
				</div>
			</div>
		</div>

		<div class="konten ml-5" style="justify-content:flex-start;">
			<?php if (!empty($konten)) : ?>
    ...
    max-height: 192px;background-color:#363636;">
			...
			<?php else : ?>
			<div class="col-12">
				<p class="text-light">Tidak ada konten ditemukan untuk kata kunci <strong>"<?= $keyword; ?>"</strong>.
				</p>
			</div>
			<?php endif; ?>
		</div>
